...
export const GET_RESTAURANT_BY_USER_ID_REQUEST = "GET_RESTAURANT_BY_ID_USER_REQUEST";
export const GET_RESTAURANT_BY_USER_ID_SUCCESS = "GET_RESTAURANT_BY_ID_USER_SUCCESS";
export const GET_RESTAURANT_BY_USER_ID_FAILURE = "GET_RESTAURANT_BY_ID_USER_FAILURE";
...
export const DELETE_EVENTS_FAILURE = "DELETE_EVENTS_FAILRE";
